...
struct Battery <:Storage
    ...
    function Battery(name, timesteps, region_name, type, charge_cap,
        ...
        valid. The constructor checks that timesteps is between 0 and 8784 (inclusive),
        charge_cap and discharge_cap are greater than 0.0, energy_cap is
        greater than 0.0, legacy is either "Existing" or "New", all of the
        efficiency values are between 0.0 and 1.0 (inclusive), FOR is between
        0.0 and 1.0 (inclusive) and MTTR is greater than 0. If any of these
